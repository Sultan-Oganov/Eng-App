...
import sensei from '../../../assets/images/etap.png'
import buttonGradient from '../../../assets/images/buttons.png';

export default function WellcomeEng({ navigation }) {
    return (
        <SafeAreaView style={styles.container}>
            ...
            <Text style={styles.title}>
                Английский мeждународный язык
            </Text>
            <Text style={styles.subTitle}>
                Является третьим по популярности языком в мире, после китайского и испанского. Ниндзя тоже нужно оставаться в тренде
