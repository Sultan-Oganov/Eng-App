        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.words}>
                <Text style={styles.title}>
                    Рад тебя видеть в Enapp !
                </Text>
                <Text style={styles.subTitle}>
                    Тебе предстоит долгий, но увлекательный путь изучения английского языка.{"\n"}
                    Ты готов ?
                </Text>
            </View>

            <View style={styles.buttons}>
                <TouchableOpacity onPress={() => navigation.navigate('WellcomeReady')}>
                    <ImageBackground source={buttonGradient} style={styles.trainingButton} >
                        <Text style={styles.buttonText}>Что мне нужно делать ?</Text>
                    </ImageBackground>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => navigation.navigate('WellcomeWAU')}>
                    <ImageBackground source={buttonGradient} style={styles.trainingButton} >
                        <Text style={styles.buttonText}>Ты кто ?</Text>
                    </ImageBackground>
                </TouchableOpacity>
            </View>
        </SafeAreaView>
